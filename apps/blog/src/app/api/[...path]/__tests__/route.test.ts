...
describe('API Proxy Route', () => {
  ...
  describe('GET', () => {
    ...
    it('forwards query parameters', async () => {
      ...
      const request = createMockRequest('http://localhost:3000/api/posts?page=1&limit=10');
      const params = Promise.resolve({ path: ['posts'] });
    ...
    it('handles nested paths', async () => {
      ...
      const request = createMockRequest('http://localhost:3000/api/posts/123/comments');
  ...
  describe('POST', () => {
    ...
    it('handles POST requests without body', async () => {
      ...
      const request = createMockRequest('http://localhost:3000/api/posts/sync', {
        method: 'POST',
      });
  ...
  describe('PUT', () => {
    it('proxies PUT requests with body', async () => {
      ...
      const request = createMockRequest('http://localhost:3000/api/posts/1', {
        method: 'PUT',
        body: JSON.stringify(requestBody),
      });
  ...
  describe('Error Handling', () => {
    ...
    it('handles backend error responses', async () => {
      ...
      const request = createMockRequest('http://localhost:3000/api/posts/999');
